...
exports.uploadImgToBuffer = upload.array('images', process.env.PRODUCT_IMAGE_LIMIT)

exports.resizeAndUploadImg = (req, res, next) => {

    if (!req.files) return new AppError('Please provide atleast one image for this product', 401)
